...
_C.DATASETS.SHUFFLE_CAPTION = False
...
_C.DATASETS.OVERRIDE_CLASS_NAMES = None
_C.DATASETS.USE_OVERRIDE_CLASS_NAMES = False
_C.DATASETS.SUPRESS_QUERY = None
_C.DATASETS.USE_SUPRESS_QUERY = False
_C.DATASETS.USE_PROMPT_TEMPLATE = False
...
# The backbone conv body to use, the string must match a function that is imported in modeling.model_builder.
# (e.g., 'FPN.add_fpn_ResNet101_conv5_body' to specify a ResNet-101-FPN backbone)
_C.MODEL.BACKBONE.NAME = "R-50-C4"
...
_C.MODEL.BACKBONE.OUT_INDICES = (0, 1, 2, 3)
...
_C.MODEL.LANGUAGE_BACKBONE.WEIGHTS = ""
...
_C.MODEL.ANCHOR_GENERATOR.SCALES_PER_OCTAVE = 3
...
# Remove RPN anchors that go outside the image by RPN.BOUNDARY_THRESH pixels
...
# are ignored (-1)
_C.MODEL.RPN.IOU_THRESHOLDS = [0.5, 0.5]
...
_C.MODEL.SWINT.OUT_FEATURES = ["p0", "p1", "p2", "p3"]
...
_C.SOLVER.MONITOR = 'val_loss'
_C.SOLVER.MONITOR_MODE = "max"
